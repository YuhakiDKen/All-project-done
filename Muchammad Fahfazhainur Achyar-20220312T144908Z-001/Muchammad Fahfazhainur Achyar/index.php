      ...
      <div class="col-5 bg-dark rounded text-white">
        <form method="post" action="">
          ...
          <div class="mb-3">
           ...
           <input type="password" class="form-control" name="namalengkap">
         </div>
         <button type="submit" value="Saya Pengguna Baru" name="sayapengguna" class="btn btn-primary">Saya pengguna baru</button>
